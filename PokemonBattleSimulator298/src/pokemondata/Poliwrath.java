...
public class Poliwrath extends Pokemon
{
	...
	static String name = "Poliwrath";
	String sprite = "poliwrath1.png";
	static int type1 = TypeTable.WATER;
	static int type2 = TypeTable.FIGHTING;
	static int[] validMoves = 
		...
		Names.moveNames.CIRCLE_THROW.ordinal(),
		...
		Names.moveNames.ICE_BALL.ordinal(),

...
public class Clefable extends Pokemon
{
	...
	static String name = "Clefable";
	String sprite = "clefable1.png";
	static int type1 = TypeTable.FAIRY;
	...
	static int[] validMoves = 
		...
		Names.moveNames.COSMIC_POWER.ordinal(),
		...
		Names.moveNames.FOLLOW_ME.ordinal(),
		...
		Names.moveNames.METEOR_MASH.ordinal(),
		...
		Names.moveNames.SPOTLIGHT.ordinal(),

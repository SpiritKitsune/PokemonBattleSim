...
public class Magnemite extends Pokemon
{
	...
	static String name = "Magnemite";
	String sprite = "magnemite1.png";
	static int type1 = TypeTable.ELECTRIC;
	static int type2 = TypeTable.STEEL;
	static int[] validMoves = 
		...
		Names.moveNames.MAGNET_BOMB.ordinal(),
		Names.moveNames.MAGNET_RISE.ordinal(),
		Names.moveNames.METAL_SOUND.ordinal(),
		Names.moveNames.MIRROR_SHOT.ordinal(),

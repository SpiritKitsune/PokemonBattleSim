...
public class Parasect extends Pokemon
{
	...
	static String name = "Parasect";
	String sprite = "parasect1.png";
	static int type1 = TypeTable.BUG;
	static int type2 = TypeTable.GRASS;
	static int[] validMoves = 
		...
		Names.moveNames.CROSS_POISON.ordinal(),
		...
		Names.moveNames.FELL_STINGER.ordinal(),

...
public class Charizard extends Pokemon
{
	...
	static String name = "Charizard";
	String sprite = "charizard1.png";
	...
	static int[] validMoves = 
		...
		Names.moveNames.BLAST_BURN.ordinal(),
		...
		Names.moveNames.FIRE_PLEDGE.ordinal(),
	...
	double baseDefense = 78;
	double baseSpAttack = 109;

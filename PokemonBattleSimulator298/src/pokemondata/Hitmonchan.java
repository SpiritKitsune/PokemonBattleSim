...
public class Hitmonchan extends Pokemon
{
	...
	static String name = "Hitmonchan";
	String sprite = "hitmonchan1.png";
	...
	static int[] validMoves = 
		...
		Names.moveNames.COMET_PUNCH.ordinal(),
		...
		Names.moveNames.SKY_UPPERCUT.ordinal(),

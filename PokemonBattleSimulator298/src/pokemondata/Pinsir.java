...
public class Pinsir extends Pokemon
{
	...
	static String name = "Pinsir";
	String sprite = "pinsir1.png";
	...
	static int[] validMoves = 
		...
		Names.moveNames.GUILLOTINE.ordinal(),

...
public class Jynx extends Pokemon
{
	...
	static String name = "Jynx";
	String sprite = "jynx1.png";
	static int type1 = TypeTable.ICE;
	...
	static int[] validMoves = 
		...
		Names.moveNames.DRAINING_KISS.ordinal(),
		...
		Names.moveNames.HEART_STAMP.ordinal(),
		...
		Names.moveNames.LOVELY_KISS.ordinal(),
		...
		Names.moveNames.POWDER_SNOW.ordinal(),

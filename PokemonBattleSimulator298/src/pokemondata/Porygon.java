...
public class Porygon extends Pokemon
{
	...
	static String name = "Porygon";
	String sprite = "porygon1.png";
	...
	static int[] validMoves = 
		...
		Names.moveNames.CONVERSION.ordinal(),
		Names.moveNames.CONVERSION_2.ordinal(),
		...
		Names.moveNames.LOCK_ON.ordinal(),
		Names.moveNames.MAGIC_COAT.ordinal(),
		...
		Names.moveNames.SHARPEN.ordinal(),
		...
		Names.moveNames.ZAP_CANNON.ordinal()
		};
